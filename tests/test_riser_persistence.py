"""Schema-2 persistence and legacy-project migration for riser documents."""
...
from session import SCHEMA_VERSION, Session, load_session, save_session  # noqa: E402


def test_schema_two_round_trip_preserves_connections_and_drawing(tmp_path):
